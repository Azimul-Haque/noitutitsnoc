...
@section('title', 'Edit Your Profile | ' . $member->name)
...
@section('content_header')
    <h1>
      Edit Your Profile: <b>{{ $member->name }}</b>
    ...
    <div class="row">
      <div class="col-md-10">
          <div class="box box-success">
            <div class="box-body">
              {!! Form::model($member, ['route' => ['dashboard.profile.update', $member->id], 'method' => 'PUT', 'class' => 'form-default', 'enctype' => 'multipart/form-data']) !!}
                  <div class="row">
                    <div class="col-md-6">
